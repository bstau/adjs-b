...
/** Number of bits used for CPR encoding of airborne position.
 * @const
 */
CPR.NUM_BITS_AIRBORNE = 17;

/** Number of bits used for CPR encoding of surface position.
 * @const
 */
CPR.NUM_BITS_SURFACE = 19;

/** Number of bits used for CPR encoding of position in TCP, TCP+1 messages.
 * @const
 */
CPR.NUM_BITS_TCP = 14;
 ...
 * @const
 */
CPR.NUM_LATITUDE_ZONES = 15;

/** Determine the number of longitude zones for a given latitude.
 *
...
/** Encode a latitude/longitude to a compact position report.
 *
 ...
 */
CPR.Encode = function(lat, lng, is_odd, bits) {
    var i = is_odd ? 1 : 0;
    var zone_lat_height = 90.0 / (CPR.NUM_LATITUDE_ZONES - i);
    var zone_lng_width = 360.0 / Math.max(1, CPR.NL(lat) - i);
